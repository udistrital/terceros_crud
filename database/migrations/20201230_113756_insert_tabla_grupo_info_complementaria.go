...
func (m *InsertTablaGrupoInfoComplementaria_20201230_113756) Up() {
	...
	m.SQL("INSERT INTO terceros.grupo_info_complementaria (nombre, descripcion, codigo_abreviacion, activo, fecha_creacion, fecha_modificacion) VALUES ('Informacion Evaluador Par','Informacion del evaluador par de la solicitud de un docente','Grupo_20', TRUE, LOCALTIMESTAMP, LOCALTIMESTAMP);")
