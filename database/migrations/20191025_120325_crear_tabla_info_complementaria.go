...
// DO NOT MODIFY
type CrearTablaInfoComplementaria_20191025_120325 struct {
	migration.Migration
}

// DO NOT MODIFY
func init() {
	m := &CrearTablaInfoComplementaria_20191025_120325{}
	m.Created = "20191025_120325"

	migration.Register("CrearTablaInfoComplementaria_20191025_120325", m)
}

// Run the migrations
func (m *CrearTablaInfoComplementaria_20191025_120325) Up() {
	// use m.SQL("CREATE TABLE ...") to make schema update
	m.SQL("CREATE TABLE IF NOT EXISTS terceros.info_complementaria( id serial NOT NULL, nombre character varying(100) NOT NULL, codigo_abreviacion character varying(20), activo boolean NOT NULL, tipo_de_dato character varying(20), grupo_info_complementaria_id integer NOT NULL, fecha_creacion TIMESTAMP NOT NULL, fecha_modificacion TIMESTAMP NOT NULL, CONSTRAINT pk_info_complementaria PRIMARY KEY (id), CONSTRAINT fk_grupo_info_complementaria_info_complementaria FOREIGN KEY (grupo_info_complementaria_id) REFERENCES terceros.grupo_info_complementaria(id) );")
...
func (m *CrearTablaInfoComplementaria_20191025_120325) Down() {
