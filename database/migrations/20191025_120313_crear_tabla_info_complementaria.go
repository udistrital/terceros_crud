...
func (m *CrearTablaInfoComplementaria_20191025_120313) Up() {
	...
	m.SQL("CREATE TABLE IF NOT EXISTS terceros.info_complementaria( id serial NOT NULL DEFAULT, nombre character varying(100) NOT NULL, codigo_abreviacion character varying(20), activo boolean NOT NULL, tipo_de_dato character varying(20), --Evaluar uso de UNIQUE KEY grupo_info_complementaria_id integer NOT NULL, fecha_creacion TIMESTAMP NOT NULL, fecha_modificacion TIMESTAMP NOT NULL, CONSTRAINT pk_info_complementaria PRIMARY KEY (id), CONSTRAINT fk_grupo_info_complementaria_info_complementaria FOREIGN KEY (grupo_info_complementaria_id) REFERENCES terceros.grupo_info_complementaria(id) );")
