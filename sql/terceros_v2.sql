...
COMMENT ON COLUMN terceros.info_basica.tipo_informacion_basica_id IS 'Identificador unico de la tabla tipo_informacion_basica.';
...
--||||||||||||||||||||||||||||||||||||
--Creacion tabla                para relacionar:
--               tipo_grupo_sanguineo
--               tipo_grupo_etnico
--               tipo_discapacidad
--               estado_civil
